...
public class MockGps1Service extends Service {


    private String TAG = "MockGps1Service";
            ...
            public void handleMessage(Message msg) {
                try {
                    ...
                    if (!isStop) {
                        ...
                        intent.setAction("com.example.service.MockGps1Service");
...
//        }
    ...
    public class ServiceBinder extends Binder {
        public MockGps1Service getService() {
            return MockGps1Service.this;
        }
    }
