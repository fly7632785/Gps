...
import com.jafir.mockgps.mocklocationlib.R;
...
public class LocationWidget extends LinearLayout {
    ...
    private Button locationWigdet2develop;
    ...
    private void init(final Context context) {
        ...
        locationWigdet2develop =  findViewById(R.id.location_wigdet_2_develop);
    ...
    public void refreshData() {
        ...
        if (mockLocationManager.getUseMockPosition(context)) {
            ...
            locationWigdet2develop.setVisibility(View.VISIBLE);
            locationWigdet2develop.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(context, "无法跳转到开发者选项,请先确保您的设备已处于开发者模式", Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    }
                }
            });
